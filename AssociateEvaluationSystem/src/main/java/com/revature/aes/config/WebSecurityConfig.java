...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/*/registerEmployee", "/*/viewEmployees", "/*/updateCredentials", "/*/questionTemplate", "/*/xmlParser").hasRole("ADMIN").and().authorizeRequests().and().csrf().csrfTokenRepository(csrfTokenRepository());
