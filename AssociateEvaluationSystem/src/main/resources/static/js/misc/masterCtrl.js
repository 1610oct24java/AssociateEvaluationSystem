angular
		...
		.controller(
				...
				[
						...
						function($scope, $rootScope, $log, $state, $http,
								Upload, questionBuilderService) {
							...
							$scope.submitSnippetFiles = function(isValid) {
								...
								var folderNames = [ 'SnippetTemplates',
										'SnippetSolutions' ]
								$scope.upload($scope.files,
										[ 'SnippetTemplates',
												'SnippetSolutions' ]);
								// console.log("Building snippet question from
								// text");

								// Upload question complete with URLs to the
								// database
								...
								builder.createSnippetQuestionBuilder(
										questionText, fileType,
										snippetTemplateUrl, snippetSolutionUrl);
								builder.addQuestionCategory(1,
							...
							$scope.submitSnippetText = function(isValid) {
								...
								// console.log("/s3uploadTextAsFile/" +
								...
								// Update database with question, complete with
								// URLs
								questionJSON = JSON.stringify(question);
								// console.log(question);
								$http({
							...
							$scope.someFunction = function(data, status,
									headers, config) {
								// keeping it to shut up sonarQube. This is that
								// hot fix doe.
							};
