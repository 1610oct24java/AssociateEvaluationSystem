...
bankApp.controller('MasterCtrl',function($scope, $http, $log, SITE_URL, API_URL, ROLE){
...
bankApp.controller('QuestionCtrl', function($http, $scope) {
	$scope.fList;
	/*
