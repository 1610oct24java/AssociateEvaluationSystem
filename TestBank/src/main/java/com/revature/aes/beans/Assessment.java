...
public class Assessment implements Serializable
{
	...
	public Assessment(Integer assessmentId, User user, Integer grade, Integer timeLimit, LocalDate createdTimestamp,
			LocalDate finishedTimestamp, Template template)
	{
		this();
	...
	public LocalDate getFinishedTimestamp()
	{
		return finishedTimestamp;
	}
	public void setFinishedTimestamp(LocalDate finishedTimestamp)
	{
		this.finishedTimestamp = finishedTimestamp;
	}
